              ...
              <div className='mt-4  flex flex-col gap-6 '>
                ...
                <div className='flex flex-col lg:flex-row lg:justify-between lg:items-center '>
                  <div className='flex items-center mb-4 lg:mb-0 '>
                    <img
                      src={channelDate?.snippet?.thumbnails?.default?.url}
                      alt={channelDate?.snippet?.title}
                      className='w-12 h-12 rounded-full '
                    />
                    <div className='mt-3 ml-2 lg:mt-0 '>
                      <h3 className='text-lg font-bold'>
                        {channelDate?.snippet?.title}
                      </h3>
                      <p className={`font-medium text-sm  ${isDarkMode ? "text-gray-200" : "text-gray-700"}`}>
                        {
                          formatViewCount(channelDate?.statistics?.subscriberCount)} {" "} subscribers
                  ...
                  <div className='flex items-center justify-center space-x-4 '>
                    <button className={`flex items-center space-x-2  rounded-full px-4 py-2 md:px-6 md:py-3 ${
