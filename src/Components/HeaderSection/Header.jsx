...
// import SpinnerLodder from '../../utilis/SpinnerLodder';
// import { CgClapperBoard, CgClose } from 'react-icons/cg';
// import { SlMenu } from 'react-icons/sl';
// import { Link, useNavigate } from 'react-router-dom';
// import Desktop_logo from '../../youtube_zist/yt_dekstop.png'
// import mobile_logo from '../../youtube_zist/youtube_mobile.png'
...
//   return (
//     <div className={`sticky top-0 z-10 flex flex-row items-center  justify-between h-20 shadow-lg px-4 md:px-5 ${isDarkMode ? "bg-gray-900" : "bg-white"} text-${isDarkMode ? "bg-white" : "bg-gray-700" }`}>
//       {loading && <SpinnerLodder/>}

//       <div className='flex h-5 items-center'>
//         <div className={`flex md:hidden md:mr-6 cursor-pointer items-center justify-center h-9 w-9 rounded-full hover:bg-${isDarkMode ? "gray-700" : "gray-300"}`}
...
//           <img src={Desktop_logo} alt='youtube_desktop_logo' className={`hidden md:block h-full object-contain ${isDarkMode ? "invert" : ""} ` } />
//           <img src={mobile_logo} alt='youtube_mobile_logo' className={`md:hidden  h-14 object-contain ${isDarkMode ? "invert" : ""} ` } />
//         </Link>
...
//             {
//               searchQuery && (
//                 <button className='absolute right-32 top-1/2 transform -translate-y-1/2'
...
//         <button className={`flex items-center justify-center w-[40px] md:w-[60px] h-10 rounded-r-3xl border border-l-0 ${isDarkMode ? "border-gray-700" : "border-gray-300"} bg-${isDarkMode ? "gray-700" :" gray-100" } `}
//           onClick={handleSearchQuery}
//         >
//             <IoIosSearch className='text-xl'/>
//         </button>
//         <button className={`flex items-center justify-center w-[40px] md:w-[60px] h-8 md:h-10 rounded-full hover:bg-${isDarkMode ? "gray-700" :" gray-300" } `}
//           // onClick={handleSearchQuery}
//         >
...
//             <button
//             className={`hidden md:flex items-center justify-center h-10 w-10 rounded-full bg-${
...
// import { useAppContext } from "../../useContextHook/useContextApi";
// import { useTheme } from "../../useContextHook/useThreme";
// import SpinnerLoader from "../../utilis/SpinnerLodder";
